package com.mifu.yygh.order.utils;
                ...
                if (isCert) {
                    ...
                    SSLConnectionSocketFactory sslsf =
                            new SSLConnectionSocketFactory(sslContext,
                                    /**
                                     * bug  按照之前学习时写的方法  会报错  No appropriate protocol (protocol is disabled or cipher suites are inappropriate)
                                     * 去看微信支付的官方文档  发现微信服务端更新取消了TLSv1协议
                                     * 最快速的解决办法就是注释掉下面两行
                                     */
//                                    new String[] { "TLSv1" },
//                                    null,
